...
def parse_args():
    ...
    parser.add_argument("--pdb", type=str, default="./7ulg.pdb", help="Path to the PDB file.")
    parser.add_argument("--iterations", type=int, choices=[25, 50, 100, 150, 200], default=50, help="Number of iterations.")
    parser.add_argument("--hotspot", type=str, default="A46-49", help="Hotspot residues.")
    parser.add_argument("--num_designs", type=int, choices=[1, 2, 4, 8, 16, 32], default=3, help="Number of designs to generate.")
    ...
    parser.add_argument("--chains", type=str, default="A", help="Chains to filter PDB input.")
    ...
    parser.add_argument("--num_seqs", type=int, choices=[1, 2, 4, 8, 16, 32, 64], default=4, help="Number of sequences to generate.")
